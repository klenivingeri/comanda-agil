const buttonOrange = ({ wFull, isPressed, press, disabled }) => `
  relative text-white font-bold rounded-lg shadow-sm transition-all duration-70 ease-in-out
  ${!wFull ? "w-full" : wFull}
  ${
    disabled
    ...
    ${
      isPressed || press
        ...
        : "bg-gradient-to-br from-[var(--button-orange-hover)] to-[var(--button-orange-default)] border-1 border-[var(--button-orange-default)] hover:bg-[var(--button-orange-hover)] border-b-3 border-b-[var(--button-orange-default)] cursor-pointer will-change-transform will-change-background"
    }`
  }
`;
  ...
  ${
    ...
    ${
      isPressed || press
        ...
        : "bg-gradient-to-br from-[var(--button-green-hover)] to-[var(--button-green-default)] border-1 border-[var(--button-green-default)] hover:bg-[var(--button-green-hover)] border-b-3 border-b-[var(--button-green-default)] cursor-pointer will-change-transform will-change-background"
    }`
  }
`;
...
const buttonDefault = ({ wFull, isPressed, press, disabled }) => `
  ...
  ${
    ...
    ${
      isPressed || press
        ? "text-white bg-gradient-to-br from-[var(--button-hover)] via-[var(--button-default)] to-[var(--button-default)] border-1 border-[var(--button-default)] border-b-1 border-b-[var(--button-default)] cursor-pointer"
        : "text-white bg-gradient-to-br from-[var(--button-hover)] via-[var(--button-default)] to-[var(--button-default)] border-1 border-[var(--button-default)] will-change-transform will-change-background border-b-3 border-b-[var(--button-default)] cursor-pointer"
    }`
  }
`;
